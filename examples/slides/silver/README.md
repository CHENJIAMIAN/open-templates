...
This example package is the public-facing companion for the `silver` slide template.

## Purpose

Use this template for neutral, clean presentations that need a restrained and broadly usable visual style.
