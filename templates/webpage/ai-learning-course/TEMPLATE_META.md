...
AI 工程师学习课程页面，Neo-brutalism 设计风格
...
| 区域 | ID | 说明 |
|------|------|------|
| 菜单按钮 | `#menu-toggle` | 移动端菜单切换按钮 |
| 移动菜单 | `#mobile-menu` | 移动端导航菜单 |
| 课程大纲 | `#curriculum` | 课程内容大纲区域 |
| 功能特点 | `#features` | 课程特点展示区域 |
| 定价方案 | `#pricing` | 价格方案展示区域 |

### 修改方式

- **修改内容**：直接编辑 HTML 中各 section 的文本和结构
- **修改样式**：使用 Tailwind CSS 类名调整
